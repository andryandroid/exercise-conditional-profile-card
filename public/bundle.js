...
function render(variables = {}) {
  ...
  if (variables.socialMediaPosition != null) socialMediaPosition = variables.socialMediaPosition;
  ...
  if (variables.twitter != null) {
    socialTwitter = `<li><a href='https://twitter.com/${variables.twitter}'><i class="fa fa-twitter"></i></a></li>`;
  }
  let socialGithub = "";
  if (variables.github != null) {
    socialGithub = `<li><a href="https://github.com/${variables.github}"><i class="fa fa-github"></i></a></li>`;
  }
  let socialLinkedin = "";
  if (variables.linkedin != null) {
    socialLinkedin = `<li><a href="https://linkedin.com/${variables.linkedin}"><i class="fa fa-linkedin"></i></a></li>`;
  }
  let socialInstagram = "";
  if (variables.instagram != null) {
    socialInstagram = `<li><a href="https://instagram.com/${variables.instagram}"><i class="fa fa-instagram"></i></a></li>`;
  }
